...
public class Program
{
    ...
    static void SaveScene(Simplygon.ISimplygon sg, Simplygon.spScene sgScene, string path)
    {
        ...
        string outputScenePath = string.Join("", new string[] { "output\\", "ComputeCasting", "_", path });
    ...
    static void SetupCastingCodeInMaterial(Simplygon.ISimplygon sg, Simplygon.spMaterial sgMaterial)
    {
