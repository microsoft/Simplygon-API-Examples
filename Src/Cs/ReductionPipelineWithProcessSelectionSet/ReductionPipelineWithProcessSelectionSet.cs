...
public class Program
{
    ...
    static void SaveScene(Simplygon.ISimplygon sg, Simplygon.spScene sgScene, string path)
    {
        ...
        string outputScenePath = string.Join("", new string[] { "output\\", "ReductionPipelineWithProcessSelectionSet", "_", path });
    ...
    static void RunReduction(Simplygon.ISimplygon sg)
    {
        ...
        using Simplygon.spSelectionSet sgReductionTargetSelectionSet = sg.CreateSelectionSet();
