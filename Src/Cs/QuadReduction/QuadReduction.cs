...
public class Program
{
    ...
    static void SaveScene(Simplygon.ISimplygon sg, Simplygon.spScene sgScene, string path)
    {
        ...
        string outputScenePath = string.Join("", new string[] { "output\\", "QuadReduction", "_", path });
    ...
    static void RunReduction(Simplygon.ISimplygon sg)
    {
        ...
        using Simplygon.spQuadReductionProcessor sgQuadReductionProcessor = sg.CreateQuadReductionProcessor();
        sgQuadReductionProcessor.SetScene( sgScene );
        using Simplygon.spQuadReductionSettings sgQuadReductionSettings = sgQuadReductionProcessor.GetQuadReductionSettings();
