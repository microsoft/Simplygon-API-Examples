...
public class Program
{
    ...
    static void SaveScene(Simplygon.ISimplygon sg, Simplygon.spScene sgScene, string path)
    {
        ...
        string outputScenePath = string.Join("", new string[] { "output\\", "QuadReductionPipeline", "_", path });
    ...
    static void RunReduction(Simplygon.ISimplygon sg)
    {
        ...
        // Create the quad reduction pipeline. 
        using Simplygon.spQuadReductionPipeline sgQuadReductionPipeline = sg.CreateQuadReductionPipeline();
        using Simplygon.spQuadReductionSettings sgQuadReductionSettings = sgQuadReductionPipeline.GetQuadReductionSettings();
        ...
        // expect. 
        sgQuadReductionSettings.SetReductionTargets( Simplygon.EStopCondition.All, false, false, false, true );
        sgQuadReductionSettings.SetReductionTargetOnScreenSize( 100 );
        
        // Start the quad reduction pipeline.         
        Console.WriteLine("Start the quad reduction pipeline.");
        sgQuadReductionPipeline.RunScene(sgScene, Simplygon.EPipelineRunMode.RunInThisProcess);
        
        // Get the processed scene. 
        using Simplygon.spScene sgProcessedScene = sgQuadReductionPipeline.GetProcessedScene();
