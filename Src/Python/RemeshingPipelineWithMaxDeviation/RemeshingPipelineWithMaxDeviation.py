...
def SaveScene(sg: Simplygon.ISimplygon, sgScene: Simplygon.spScene, path: str):
    ...
    outputScenePath = ''.join(['output\\', 'RemeshingPipelineWithMaxDeviation', '_', path])
...
def RunRemeshing(sg: Simplygon.ISimplygon):
    ...
    sgRemeshingSettings.SetRemeshingTarget( Simplygon.ERemeshingTarget_MaxDeviation )
    
    # Set the MaxDeviation. 
    sgRemeshingSettings.SetMaxDeviation( 0.02 )
