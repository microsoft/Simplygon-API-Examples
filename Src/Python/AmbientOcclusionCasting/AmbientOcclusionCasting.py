...
def SaveScene(sg: Simplygon.ISimplygon, sgScene: Simplygon.spScene, path: str):
    ...
    outputScenePath = ''.join(['output\\', 'AmbientOcclusionCasting', '_', path])
...
def AmbientOcclusionCasting(sg: Simplygon.ISimplygon):
    ...
    sgAmbientOcclusionCaster = sg.CreateAmbientOcclusionCaster()
    ...
    sgAmbientOcclusionCasterSettings = sgAmbientOcclusionCaster.GetAmbientOcclusionCasterSettings()
    sgAmbientOcclusionCasterSettings.SetMaterialChannel( 'AmbientOcclusion' )
    sgAmbientOcclusionCasterSettings.SetRaysPerPixel( 64 )
    sgAmbientOcclusionCasterSettings.SetOutputImageFileFormat( Simplygon.EImageOutputFormat_PNG )
    ...
    sgAmbientOcclusionTexture = sg.CreateTexture()
    ...
    sgAmbientOcclusionTextureShadingNode = sg.CreateShadingTextureNode()
