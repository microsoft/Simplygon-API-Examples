...
def SaveScene(sg: Simplygon.ISimplygon, sgScene: Simplygon.spScene, path: str):
    ...
    outputScenePath = ''.join(['output\\', 'QuadReductionPipeline', '_', path])
...
def RunReduction(sg: Simplygon.ISimplygon):
    ...
    sgQuadReductionPipeline = sg.CreateQuadReductionPipeline()
    sgQuadReductionSettings = sgQuadReductionPipeline.GetQuadReductionSettings()
    ...
    print("Start the quad reduction pipeline.")
    sgQuadReductionPipeline.RunScene(sgScene, Simplygon.EPipelineRunMode_RunInThisProcess)
    
    # Get the processed scene. 
    sgProcessedScene = sgQuadReductionPipeline.GetProcessedScene()
