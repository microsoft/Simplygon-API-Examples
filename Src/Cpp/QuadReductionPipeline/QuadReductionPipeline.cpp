...
void SaveScene(Simplygon::ISimplygon* sg, Simplygon::spScene sgScene, const char* path)
{
	...
	std::string outputScenePath = std::string("output\\") + std::string("QuadReductionPipeline") + std::string("_") + std::string(path);
...
void RunReduction(Simplygon::ISimplygon* sg)
{
	...
	Simplygon::spQuadReductionPipeline sgQuadReductionPipeline = sg->CreateQuadReductionPipeline();
	Simplygon::spQuadReductionSettings sgQuadReductionSettings = sgQuadReductionPipeline->GetQuadReductionSettings();
	...
	Simplygon::spScene sgProcessedScene = sgQuadReductionPipeline->GetProcessedScene();
