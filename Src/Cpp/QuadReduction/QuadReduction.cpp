...
void SaveScene(Simplygon::ISimplygon* sg, Simplygon::spScene sgScene, const char* path)
{
	...
	std::string outputScenePath = std::string("output\\") + std::string("QuadReduction") + std::string("_") + std::string(path);
...
void RunReduction(Simplygon::ISimplygon* sg)
{
	...
	Simplygon::spQuadReductionProcessor sgQuadReductionProcessor = sg->CreateQuadReductionProcessor();
	sgQuadReductionProcessor->SetScene( sgScene );
	Simplygon::spQuadReductionSettings sgQuadReductionSettings = sgQuadReductionProcessor->GetQuadReductionSettings();
