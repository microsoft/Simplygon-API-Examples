...
void SaveScene(Simplygon::ISimplygon* sg, Simplygon::spScene sgScene, const char* path)
{
	...
	std::string outputScenePath = std::string("output\\") + std::string("ReductionPipelineWithSymmetrySettings") + std::string("_") + std::string(path);
...
void RunReduction(Simplygon::ISimplygon* sg)
{
	...
	sgReductionSettings->SetSymmetryAxis( Simplygon::ESymmetryAxis::X );
